...
export const memberFinanceUseCases = {
  submitPayment: async (payload) =>
    (await financeApi.submitPayment(payload)).data,
  ...
  getReceipt: async (paymentId) =>
    (await financeApi.getReceipt(paymentId)).data,
  submitFundRequest: async (payload) =>
    (await financeApi.submitFundRequest(payload)).data,
  loadMyFundRequests: async () =>
    (await financeApi.getMyFundRequests()).data.fundRequests,
};
