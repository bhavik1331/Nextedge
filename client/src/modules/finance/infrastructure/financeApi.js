...
export const financeApi = {
  ...
  markMemberPaid: (memberId, payload) =>
    api.patch(`/finance/members/${memberId}/fee-status`, payload),
  sendReminder: (memberId) => api.post(`/finance/members/${memberId}/reminder`),
  exportMemberFees: (params = {}) =>
    api.get("/finance/members/export", { params, responseType: "blob" }),
  ...
  approvePayment: (id, payload = {}) =>
    api.patch(`/finance/payments/${id}/approve`, payload),
  rejectPayment: (id, payload) =>
    api.patch(`/finance/payments/${id}/reject`, payload),
  clarifyPayment: (id, payload) =>
    api.patch(`/finance/payments/${id}/clarify`, payload),
  getReceipt: (id) => api.get(`/finance/payments/${id}/receipt`),

  getLedger: (params = {}) => api.get("/finance/ledger", { params }),
  exportLedger: (format = "csv") =>
    api.get("/finance/ledger/export", {
      params: { format },
      responseType: "blob",
    }),
  addManualLedgerEntry: (payload) =>
    api.post("/finance/ledger/manual-entry", payload),
  reverseLedgerEntry: (id, payload) =>
    api.post(`/finance/ledger/${id}/reverse`, payload),

  getFundRequests: (params = {}) =>
    api.get("/finance/fund-requests", { params }),
  getMyFundRequests: () => api.get("/finance/fund-requests/mine"),
  submitFundRequest: (payload) => api.post("/finance/fund-requests", payload),
  approveFundRequest: (id, payload = {}) =>
    api.patch(`/finance/fund-requests/${id}/approve`, payload),
  rejectFundRequest: (id, payload) =>
    api.patch(`/finance/fund-requests/${id}/reject`, payload),
  releaseFundRequest: (id, payload) =>
    api.patch(`/finance/fund-requests/${id}/release`, payload),
  ...
  reverseExpense: (id, payload) =>
    api.post(`/finance/expenses/${id}/reverse`, payload),
